...
namespace Runtime.GameModes.Wizard
{
    ...
    /// </summary>
    public sealed partial class GameModeWizardCoordinator
    {
        ...
        private (CancellationTokenSource? wizardCts, Task? processingTask, IGameModeSession? session, bool shouldPublishAbort) DetachWizardState()
        {
            lock (_lifecycleLock)
            {
        ...
        private static void DisposeSessionAndCts(IGameModeSession? session, CancellationTokenSource? wizardCts)
        {
            try
            {
                session?.Dispose();
