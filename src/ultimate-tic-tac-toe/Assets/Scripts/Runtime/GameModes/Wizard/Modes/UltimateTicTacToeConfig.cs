...
namespace Runtime.GameModes.Wizard.Modes
{
    ...
    {
        private static readonly IReadOnlyList<KeyValuePair<string, string>> _matchmakingParams =
        ...
        public IReadOnlyList<KeyValuePair<string, string>> GetMatchmakingParams() => _matchmakingParams;
    }
}
