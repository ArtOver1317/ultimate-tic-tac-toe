...
namespace Tests.EditMode.Games.TicTacToe.UI.Hud
{
    ...
    public sealed class MoveTimerHudTests
    {
        ...
        [Test]
        public void WhenNormalizeDisplaySecondsWithNegativeValue_ThenReturnsZero() => MoveTimerDisplayFormatter.NormalizeDisplaySeconds(-0.2f).Should().Be(0);

        [Test]
        public void WhenFormatSecondsWithOverMinuteValue_ThenReturnsMinuteSecondText() => MoveTimerDisplayFormatter.FormatSeconds(125).Should().Be("02:05");
