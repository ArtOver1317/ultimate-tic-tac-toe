...
namespace Tests.EditMode.Games.TicTacToe.AI.Search
{
    [TestFixture]
    [Category("Unit")]
    public class MinimaxDecisionEngineTests
    {
        ...
        {
            var winLength = ClassicRulesEngine.GetWinLength(boardSize);
        ...
        /// </summary>
        private static readonly BotSearchSettingsData _noCapsSettings = new(
        ...
        public IEnumerator WhenCancellationTokenCancelled_ThenThrowsOperationCanceledException() =>
            UniTask.ToCoroutine(async () =>
            {
                ...
                var request = MakeRequest(cells, 5, activeSlot: 0, lastMove: new CellId(1, 1),
                    searchSettingsOverride: _noCapsSettings);
