...
namespace Tests.EditMode.Games.TicTacToe
{
    ...
    public class UltimateRulesEngineTests
    {
        ...
        public void SetUp()
        {
            _engine = new UltimateRulesEngine();
        }
        ...
        public void WhenLastMoveMinorTargetsOpenMiniBoard_ThenAllowsOnlyTargetMajor()
        {
            ...
            var result = _engine.EvaluateAfterMove(cells, OuterSize, InnerSize, new CellId(4, 2), miniBoards);

            result.AllowedMajors.Mask.Should().Be((ushort)(1 << 2));
        ...
        public void WhenLastMoveMinorTargetsClosedMiniBoard_ThenAllowsAllOpenMajors()
        {
            ...
            var result = _engine.EvaluateAfterMove(cells, OuterSize, InnerSize, new CellId(0, 5), miniBoards);
        ...
        public void WhenMiniBoardGetsWinningLine_ThenReturnsMiniBoardDeltaWithWinnerStatus()
        {
            ...
            var result = _engine.EvaluateAfterMove(cells, OuterSize, InnerSize, new CellId(7, 2), miniBoards);
        ...
        public void WhenMiniBoardBecomesFullWithoutWinner_ThenReturnsDrawDelta()
        {
            ...
            var result = _engine.EvaluateAfterMove(cells, OuterSize, InnerSize, new CellId(3, 8), miniBoards);
        ...
        public void WhenMiniBoardStatusesContainBigBoardWin_ThenReturnsMatchWinWithDeterministicLine()
        {
            ...
            var result = _engine.EvaluateAfterMove(cells, OuterSize, InnerSize, new CellId(2, 2), miniBoards);
        ...
        public void WhenBigBoardHasNoWinnerAndNoOpenMiniBoards_ThenReturnsDraw()
        {
            ...
            var result = _engine.EvaluateAfterMove(cells, OuterSize, InnerSize, new CellId(8, 8), miniBoards);
        ...
        public void WhenMultipleBigBoardWinsExist_ThenPrefersRowsOverColumnsAndDiagonals()
        {
            ...
            var result = _engine.EvaluateAfterMove(cells, OuterSize, InnerSize, new CellId(6, 0), miniBoards);
        ...
        public void WhenCellAtLastMoveIsNone_ThenThrowsArgumentException()
        {
            ...
            Action act = () => _engine.EvaluateAfterMove(cells, OuterSize, InnerSize, new CellId(0, 0), miniBoards);

            act.Should().Throw<ArgumentException>();
        }

        private static PlayerMark[] CreateEmptyCells() => new PlayerMark[MajorCount * MinorCount];
        ...
        private static void SetCell(PlayerMark[] cells, int major, int minor, PlayerMark value)
        {
            cells[major * MinorCount + minor] = value;
        }

        private static void SetMiniBoard(PlayerMark[] cells, int major, PlayerMark[] values)
        {
            values.Length.Should().Be(MinorCount);
            for (var minor = 0; minor < MinorCount; minor++)
            {
                cells[major * MinorCount + minor] = values[minor];
            }
        }
    }
}