...
namespace Tests.EditMode.Games.TicTacToe.Rules
{
    ...
    public partial class ClassicRulesEngineTests
    {
        ...
        [SetUp]
        public void SetUp() => _engine = new ClassicRulesEngine();
        ...
        [TestCase(6, 5)]
        [TestCase(10, 5)]
        public void WhenGetWinLength_ThenReturnsCorrectK(int boardSize, int expectedK) => ClassicRulesEngine.GetWinLength(boardSize).Should().Be(expectedK);
