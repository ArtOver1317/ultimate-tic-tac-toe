...
namespace Tests.EditMode.Games.TicTacToe.AI.Ultimate.Decision
{
    [TestFixture]
    [Category("Unit")]
    public class UltimateBotDecisionEngineTests
    {
        ...
        private static UltimateBotDecisionRequest BuildRequest(
            ...
            BuildRequest(legal, profile, new PlayerMark[81], BuildMiniBoards(), AllowedMajors.All, new XorShift32BotRngSession(42));
