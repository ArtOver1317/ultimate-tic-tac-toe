...
namespace Tests.EditMode.GameModes.Wizard.UI.Components
{
    [TestFixture]
    [Category("Unit")]
...
#pragma warning restore CS8625
        ...
        public void WhenSetItemsCalledWithValidItems_ThenCreatesButtonsWithCorrectLabels()
        {
            ...
            _radio.Q<Button>(nameof(HumanOpponentKind.Local)).text.Should().Be("Local");
            _radio.Q<Button>(nameof(HumanOpponentKind.DirectInvite)).text.Should().Be("Invite");
        }
        ...
        public void WhenSetItemsCalledAndPreviouslySelectedKindStillExists_ThenSelectionIsPreserved()
        {
            ...
            _radio.Q<Button>(nameof(HumanOpponentKind.Local))
