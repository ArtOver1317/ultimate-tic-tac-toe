...
namespace Tests.EditMode.GameModes.Wizard.UI.MatchSetup
{
    ...
    public class MatchSetupUxmlContractTests
    {
        ...
        {
            // Arrange
            var uxml = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(_matchSetupUxmlPath);
        ...
        {
            // Arrange
            var uxml = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(_classicSettingsUxmlPath);
            uxml.Should().NotBeNull();
        ...
        {
            // Arrange
            var uxml = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(_ultimateSettingsUxmlPath);
            uxml.Should().NotBeNull();
